...
A Retrieval Augmented Generation application deployed on Azure, using 

- Azure OpenAI Service (chat and embeddings models), 
- and Azure AI Search

The original code is from [alfredodeza/azure-rag](https://github.com/alfredodeza/azure-rag).
